    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-alerts.jsp" class="active">
              <i class="bi bi-circle"></i><span>Alerts</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-accordion.jsp">
              <i class="bi bi-circle"></i><span>Accordion</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-badges.jsp">
              <i class="bi bi-circle"></i><span>Badges</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-breadcrumbs.jsp">
              <i class="bi bi-circle"></i><span>Breadcrumbs</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-buttons.jsp">
              <i class="bi bi-circle"></i><span>Buttons</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-cards.jsp">
              <i class="bi bi-circle"></i><span>Cards</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-carousel.jsp">
              <i class="bi bi-circle"></i><span>Carousel</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-list-group.jsp">
              <i class="bi bi-circle"></i><span>List group</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-modal.jsp">
              <i class="bi bi-circle"></i><span>Modal</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-tabs.jsp">
              <i class="bi bi-circle"></i><span>Tabs</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-pagination.jsp">
              <i class="bi bi-circle"></i><span>Pagination</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-progress.jsp">
              <i class="bi bi-circle"></i><span>Progress</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-spinners.jsp">
              <i class="bi bi-circle"></i><span>Spinners</span>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/resources/components-tooltips.jsp">
